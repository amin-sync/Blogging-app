...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // configuring JWT in security config

        http.csrf()
                .disable()
                .authorizeHttpRequests()
//                .antMatchers("/api/v1/auth/**").permitAll() // this URL can be access by anyone
                .antMatchers(PUBLIC_URLS).permitAll()
                .antMatchers(HttpMethod.GET).permitAll() // All the GET methods of whole API can be access by anyone
